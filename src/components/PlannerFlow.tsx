...
const PLANNER_OPTIONS: PlannerOption[] = [
    {
        ...
        price: 1200,
        pdfUrl: "https://drive.google.com/file/d/1NetkdL2uUSv7tmqpcTtXsa52v3P_ZKo3/preview",
        downloadUrl: "https://drive.google.com/uc?export=download&id=1NetkdL2uUSv7tmqpcTtXsa52v3P_ZKo3",
        features: [
    ...
    },
    {
        ...
        downloadUrl: "https://drive.google.com/uc?export=download&id=1Mktv7tjKYcG3CThZWpT27eurC8G4YnOw",
        features: [
...
export const PlannerFlow = () => {
    const [selectedPlanner, setSelectedPlanner] = useState<PlannerOption | null>(null);
                ...
                <Card className="p-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center p-3 bg-muted rounded-lg">
                            ...
                            <span className="text-sm font-medium">{selectedPlanner.price} tk</span>
                        </div>
                    </div>
                </Card>
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="py-3">
                                        <div className="flex items-baseline gap-1">
                                            <span className="text-3xl font-bold">{planner.price}</span>
                                ...
                                {isPreviewing && (
                                    <div className="mt-4">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-2 text-center">
                                            If the preview doesn't load, please click "Download" to view the PDF
                                        </p>
                                    </div>
                                )}
                            </div>
